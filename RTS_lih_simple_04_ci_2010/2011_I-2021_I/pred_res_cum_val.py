"""
Валидационная выборка. Результаты по моделям.
...
data_path = Path(fr"pred_res_cum_val.csv")
...
for counter in range(1, 101):  # ------------------------------------------------------------------
    ...
    # === 1. ЗАГРУЗКА ДАННЫХ ===
    df_fut = data_load(db_path, '2020-07-01', '2022-01-01')
    ...
    df = df_fut[df_fut['TRADEDATE'] > '2021-01-01'].copy()
