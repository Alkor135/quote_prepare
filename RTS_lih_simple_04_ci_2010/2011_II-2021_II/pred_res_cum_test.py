"""
Тестовая выборка. Результаты по моделям.
...
data_path = Path(fr"pred_res_cum_test.csv")
...
for counter in range(1, 101):  # ------------------------------------------------------------------
    ...
    # === 1. ЗАГРУЗКА ДАННЫХ ===
    df_fut = data_load(db_path, '2022-01-01', '2022-12-31')
    ...
    df = df_fut[df_fut['TRADEDATE'] > '2022-06-30'].copy()
